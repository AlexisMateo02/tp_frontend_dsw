...
function Wishlist() {
  ...
  const [cart, setCart] = useState([]); //aparece lo de cart (carrito) porque podemos agregar desde la wishlist productos al carrito
  ...
  useEffect(() => {
    try {
      ...
      // en caso de error, limpiar todo y deja todo en 0
      setCart([]);
      setCurrentUser(null);
      setWishlist([]);
    }
  ...
  // Función para eliminar un producto de la wishlist, lo tenemos solo en el localstorage
  ...
  const addToCart = (product) => {
    try {
      // No permitir agregar al carrito si no hay stock
  ...
  // Componente modal para invitar al usuario a iniciar sesión. Cuando tiene que agregar al carrito pero no está logueado (La misma que en cart)
  const LoginModal = () => (
    <div
  ...
  //Diseñamos la vista de la wishlist
  return (
    <>
                ...
                <div className="card h-100 shadow-sm border-0">
                  ...
                  <div className="card-body d-flex flex-column text-center">
                    ...
                    <div className="md-auto d-flex justify-content-between gap-2">
                      ...
                      <button
                        className="btn w-100"
                        onClick={() => removeFromWishlist(product.id)} //lo que hace el voto Eliminat de favoritos es invocar removeFromWishlist y envia comoparametro el id del producto
                      >
                        <i className="ri-shopping-cart-2-line me-1">
